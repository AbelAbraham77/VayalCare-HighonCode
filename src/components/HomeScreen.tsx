...
const HomeScreen: React.FC<HomeScreenProps> = ({
  ...
  return <div className="pb-20 bg-background min-h-screen transition-colors duration-300">
        ...
        <div className="relative z-10 p-6 h-full flex flex-col justify-center">
          ...
          <div className="mt-3 flex flex-col items-start gap-1">
            <div className="flex items-baseline">
              <span className="text-foreground text-3xl sm:text-4xl font-semibold">36°</span>
      ...
      <Button variant="default" className="fixed top-4 right-4 z-20 h-14 w-14 rounded-full shadow-lg transition-colors duration-300" onClick={() => console.log('Voice assistant activated')}>
      ...
      <div className="p-4 space-y-6">
              ...
              description: language === 'ml' ? 'പ്ലേസ്‌ഹോൾഡർ - നിങ്ങൾ പിന്നീട് പുതുക്കാം' : 'Placeholder - you can update later'
                  ...
                  <div className="w-12 h-12 text-primary flex items-center justify-center mx-auto mb-2">
                    {('image' in action && action.image) ? (
                      <img src={action.image as string} alt={`${action.label} icon`} className="h-10 w-10 md:h-12 md:w-12 object-contain-center" loading="lazy" />
                    ) : (
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            <h2 className="hidden md:block text-lg font-semibold text-foreground">{language === 'ml' ? 'ഫീച്ചർ കണ്ടന്റ്' : 'Feature Content'}</h2>
          </div>
          <div className="space-y-2">
            ...
            <div className="relative overflow-hidden rounded-md" style={{ containerType: 'inline-size' }}>
              <div className="marquee marquee-right gap-2 md:gap-3 items-stretch" style={{ animationDuration: '30s' }}>
            ...
            <div className="relative overflow-hidden rounded-md" style={{ containerType: 'inline-size' }}>
              <div className="marquee marquee-left gap-2 md:gap-3 items-stretch" style={{ animationDuration: '30s' }}>
                {[...featureContent, ...featureContent].map((item, idx) => (
                  <div
        ...
        {/* Main Features Grid */}
        <div>
          <h2 className="text-lg font-semibold text-foreground mb-4 transition-colors duration-300">{getTranslatedText('Farm Management')}</h2>
